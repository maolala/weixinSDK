...
public class WxFocusOnMpMessageHandler implements WxMpMessageHandler {
    ...
    public WxMpXmlOutMessage handle(WxMpXmlMessage wxMessage, Map<String, Object> context, WxMpService wxMpService, WxSessionManager sessionManager) throws WxErrorException {
        ...
        if(wxMessage.getTicket() != null) { //说明是扫二维码
            ...
            m = WxMpXmlOutMessage.TEXT().content("欢迎关注木业机器人公众号!").fromUser(wxMessage.getToUserName()).toUser(wxMessage.getFromUserName()).build();
        }
        return m;
    }
}
